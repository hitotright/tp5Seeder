      ...
      <el-row>
        <el-col :span="17">
          <el-form-item label="应用名称：" required>
            <el-select class="width_sp111" v-model="formPost.app_id" clearable placeholder="请选择"
                       :filterable=true>
              <el-option v-for="item in list" :key="item.app_id" :label="item.app_name"
                         :value="item.app_id">
              </el-option>
            </el-select>
          </el-form-item>
        ...
        <el-col :span="17">
          <el-form-item label="更新说明：" required>
            <el-input type="textarea" clearable v-model="formPost.memo" placeholder="请输入更新说明"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            handleConfirm() {
                ...
                this.$ajax.post('website/history/add', this.formPost).then(function (res) {
                    console.log(res)
                    if (res.data.error === 0) {
            ...
            initGetData(){
                let that = this;
                this.$ajax.post('website/history/getAppForSel').then(function (res) {
                    if (res.data.error === 0) {
