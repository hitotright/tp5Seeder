<template>
  ...
  <el-dialog top="10px"
    ...
    <div slot="footer" v-show="footer_show">
      ...
      <el-button type="primary" @click="handleConfirm()" title="确定上传">上 传</el-button>
    </div>
  </el-dialog>
</template>
<script>
    export default {
        ...
        methods: {
            ...
            handleConfirm() {
                ...
                this.formPost.app_id = that.app_id
                this.$ajax.post('website/app/upload', this.formPost).then(function (res) {
                    // console.log(res)
                    if (res.data.error === 0) {
